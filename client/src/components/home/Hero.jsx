    ...
    <>
      <div className="min-h-screen pb-20 ">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          <a href="/">
            <img src="/resumify.png" alt="logo img" className="h-11 w-auto" />
          </a>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          ...
          <p className="max-w-md text-center text-base my-7">
            Create a resume that stands out — customized by AI to match your
            goals and impress employers. Designed for real results.
          </p>
          ...
          <div className="flex items-center gap-4 ">
            ...
            <button className="flex items-center gap-2 border border-slate-400 hover:bg-indigo-500 transition rounded-full px-7 h-12 text-slate-700">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
