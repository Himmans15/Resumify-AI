    ...
    <>
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-indigo-200/60 to-white mt-40">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              ...
              <li>
                <a href="/" className="hover:text-indigo-700 transition">
                  Careers
                  <span className="text-xs text-white bg-indigo-700 rounded-md ml-2 px-2 py-1">
                    We’re hiring!
                  </span>
                </a>
              </li>
        ...
        <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end">
          ...
          <div className="flex items-center gap-4 mt-3">
            <a href="https://dribbble.com/" target="_blank" rel="noreferrer">
              <svg
                ...
                className="lucide lucide-dribbble size-5 hover:text-indigo-600"
                aria-hidden="true"
              >
            ...
            >
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-linkedin size-5 hover:text-indigo-600"
                aria-hidden="true"
              >
            ...
            <a href="https://x.com" target="_blank" rel="noreferrer">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-twitter size-5 hover:text-indigo-600"
                aria-hidden="true"
              >
            ...
            <a href="https://www.youtube.com" target="_blank" rel="noreferrer">
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-youtube size-6 hover:text-indigo-600"
                aria-hidden="true"
              >
          ...
          <p className="mt-3 text-center">© 2025 Resumeify</p>
        </div>
      </footer>
      <style>{`
